  ...
  */
    ...
    $('#btn-load').click(function(e) {
      ...
      if (shr.length > 1000) { // SHARE CODE
        ...
        gearSet();
    /* --- Pastebin API ---
      } else if (shr.slice(0, 20) == "https://pastebin.com") { // SHARE LINK
        var decData = function(shr, key) {
          var C = CryptoJS;
          var Key = C.enc.Utf8.parse("6il7YCRSqIOB9NooY225lPKQ0KuAF/nkFX6cY3vJkS0=");
          var IV = C.enc.Utf8.parse("br2fg9b3e7fb12q");
          var dcT = C.AES.decrypt(data, Key, {
            iv: IV,
            mode: C.mode.CBC,
            padding: C.pad.Pkcs7
          });
    ...
    */
    /* --- Heroku API ---
      } else if (shr.slice(0, 46) == "https://krsharelink.herokuapp.com/api/v1/links") {
        var decData = function(shr, key) {
          var C = CryptoJS;
          var Key = C.enc.Utf8.parse("6il7YCRSqIOB9NooY225lPKQ0KuAF/nkFX6cY3vJkS0=");
          var IV = C.enc.Utf8.parse("br2fg9b3e7fb12q");
    ...
    */
      } else if (shr.slice(0, 27) == "http://localhost:3000/links") {
        $.get(shr, function (data, textStatus, jqXHR) {
          // console.log('shr = ' + shr);
          // console.log($(data).find('.raw').text());
          var decData = function(shr, key) {
            var C = CryptoJS;
            var Key = C.enc.Utf8.parse("6il7YCRSqIOB9NooY225lPKQ0KuAF/nkFX6cY3vJkS0=");
            var IV = C.enc.Utf8.parse("br2fg9b3e7fb12q");
