(function() {
  $(document).on("turbolinks:load", function() {
      ...
      $.get(shr)
        .done((data) => {
          ...
          $(decData(rawData)).each(function(i, n) {
            ...
            if (x == 'calc[char_id]') change_char();
            if (x == 'calc[gear_weapon]') change_weapon();
            if (x == 'calc[st_weapon]') change_sw_adv();
            if (x == 'calc[st_weapon_st]') change_sw_eth();
            if (x == 'calc[gear_armor]') change_armor();
            if (x == 'calc[gear_secondary]') change_secondary();
            if (x == 'calc[gear_treasure]') change_treasure();
            ...
            if (x == 'calc[gear_orb]') change_orb();
            if (x == 'calc[gear_artifact]') change_art();
            ...
            if (x == 'calc[st_armor_op]') $('#propAr').text(y);
            if (x == 'calc[st_secondary_op]') $('#propScnd').text(y);
            if (x == 'calc[st_jewerly_op]') $('#propAcs').text(y);
            if (x == 'calc[st_orb_op]') $('#propOrb').text(y);
            ...
            if ((x == 'calc[ench_ar_st]') || (x == 'calc[ench_sg_st]') || (x == 'calc[ench_j_st]') || (x == 'calc[ench_orb_st]'))
              $('[name="' + x + '"]')
                .children('[value="' + y + '"]').prop('selected', true).end()
                .children('.q, option:selected').show();
            if (x == 'calc[jewelry_type]') $jewelType = y;
        ...
        .fail(function(jqXHR, textStatus, errorThrown) {
          $msg = `Enter valid link/code! - ${errorThrown}`;
          messgeBox();
        });
    ...
    $('#calc_role_id').change(function() {
      $('#calc_gear_weapon, #calc_gear_treasure, #calc_gear_armor, #calc_gear_secondary, #calc_gear_jewelry, #calc_gear_orb').parent().hide();
