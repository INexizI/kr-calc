(function() {
  $(document).on("turbolinks:load", function() {
    ...
    $('#btn-load').click(function(e) {
      ...
      // } else if ((window.location.origin + shr.slice(-13, -7) == "http://localhost:3000/links") || (window.location.origin + shr.slice(-13, -7) == "https://kr-calc.herokuapp.com/links") || (window.location.origin + shr.slice(-13, -7) == "www.kr-calc.com/links")) { /* --- localhost API ---  */
      //   $.get(shr)
      //     .done(function(data) {
      //       var decData = function(shr, key) {
      //         var C = CryptoJS;
